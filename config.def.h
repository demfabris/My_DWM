...
static const char *fonts[]          = { "FantasqueSansMono Nerd Font:size=16:antialias=true:autohint=true", "noto-emoji"};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_l,      spawn,          SHCMD("brave --force-device-scale-factor=1.25") },
